...
pelanggan<-pelanggan[c("Jenis.Kelamin", "Umur", "Profesi","Tipe.Residen")]
pelanggan
...
#mengubah data teks jadi numerikd dengan matriks
...
##MEMBUAT DATA MASTER = u/ membuat kolom baru yang numerik
...
##K-Means : hanya bisa data numerik, kalauu bukan numerik ubah jdi numerik(matrix)/data master
#sebelumnya data bisa dinormalisasi(dikecilkan dengan membagi dgn nilai tertentu) tanpa mengubah nilainya
...
#SS kecil semakin baik, berarti persentase (between_SS / total_SS) semakin tinggi


#Available Components
#totss : 	Total Sum of Squares (SS) untuk seluruh titik data
#withniss : Total Sum of Squares per cluster
